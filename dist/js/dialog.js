...
HSJ.T = function (t) {
  var t_;
  if (t == 0) t_ = BootstrapDialog.TYPE_DEFAULT;else if (t == 1) t_ = BootstrapDialog.TYPE_INFO;else if (t == 2) t_ = BootstrapDialog.TYPE_PRIMARY;else if (t == 3) t_ = BootstrapDialog.TYPE_SUCCESS;else if (t == 4) t_ = BootstrapDialog.TYPE_WARNING;else if (t == 5) t_ = BootstrapDialog.TYPE_DANGER;else t_ = BootstrapDialog.TYPE_DEFAULT;
  return t_;
};
...
HSJ.S = function (s) {
  var s_;
  if (s == 1) s_ = BootstrapDialog.SIZE_SMALL;else if (s == 2) s_ = BootstrapDialog.SIZE_NORMAL;else if (s == 3) s_ = BootstrapDialog.SIZE_LARGE;else if (s == 4) s_ = BootstrapDialog.SIZE_WIDE;else s_ = BootstrapDialog.SIZE_NORMAL;
  return s_;
};
...
HSJ.util = {
  ...
  alert: {
     ...
     *   f：提示框关闭后的回调方法
     **/
    base: function base(m, t, s, c, r, f) {
      var d = BootstrapDialog.show(_defineProperty({
        type: HSJ.T(t),
        title: "提示",
        message: m,
        size: HSJ.S(s)
  ...
  confirm: {
     ...
     **/
    base: function base(title, msg, t, s, btns) {
